...
format: skaidi-revealjs
author:
  - name: Ditt Navn
    orcid: 0000-0000-0000-0000
    email: fornavn.etternavn@hkdir.no
    affiliations: Utdanning.no
date: last-modified
---
...
### Some extra things you can do with the Skaidi theme
...
[demo template](https://github.com/haraldgroven/quarto-revealjs-skaidi-demo),
with more examples for integrating code, tables, figures, etc.

  - See the live demo slides
  [here](https://haraldgroven.com/quarto-revealjs-skaidi-demo/template.html).
